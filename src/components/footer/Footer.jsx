    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                ...
                <p className="text-base leading-relaxed text-gray-600 mt-7"> Empowering churches and ministries to share the Gospel through compelling media content that reaches hearts, transforms lives, and spreads hope across every digital platform.
...
Start Your Project
        ...
        <p className="text-sm text-center text-gray-600">© Copy right 2025 | Avinx Health coming soon...</p>
    </div>
</section>
    );
}
